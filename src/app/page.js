            ...
            <div className="row align-items-center">
              <div className="col-lg-8 col-sm-12">
                <h3 className="text-white">“You cannot teach
                  <span className="ps-5">a person anything,</span>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4">
              <Link href="holischtische-massage" className="blok">
            ...
            <div className="col-lg-4">
              <Link href="retreat" className="blok" style={{ background: '#ffffff4d' }}>
                <img src="./assets/img/beeldmerk.png" alt="" />
                <h2>Behandeling 1</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur mollitia el.</p>
              </Link>
            ...
            <div className="col-lg-4">
              <Link href="reviews" className="blok">
                <img src="./assets/img/beeldmerk.png" alt="" />
                <h2>Behandeling 1</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur mollitia el.</p>
              </Link>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 mt-4 mt-lg-0 mb-5 mb-lg-0">
              ...
              <Link href="over-mij">Lees meer <img src="./assets/img/angles-right-solid.svg" alt="" style={{ width: '14px', filter: ' opacity(0.5)' }} /></Link>
            </div>
          </div>
        </div>
      </section>
